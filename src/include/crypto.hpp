...
public:
	void InitializeEncryption(EncryptionNonce &nonce, const_data_ptr_t key, const_data_ptr_t aad = nullptr,
	                          idx_t aad_len = 0) override;
	void InitializeDecryption(EncryptionNonce &nonce, const_data_ptr_t key, const_data_ptr_t aad = nullptr,
	                          idx_t aad_len = 0) override;
